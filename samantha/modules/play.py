...
from samantha.config import ARQ_API_KEY
...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    image2 = Image.open("./etc/tg_vc_bot.jpg")
...
async def play(_, message: Message):
    ...
    await lel.edit("**🔎 ꜱᴇᴀʀᴄʜɪɴɢ ꜰᴏʀ ʀᴇqᴜᴇꜱᴛᴇᴅ ꜱᴏɴɢ 🔍**")
    message.from_user.id
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📜 Qᴜᴇ", callback_data="playlist"),
                    InlineKeyboardButton("Mᴇɴᴜ ⏯ ", callback_data="menu"),
                ],
                [InlineKeyboardButton(text="🎧 Wᴀᴛᴄʜ Oɴ Yᴏᴜᴛᴜʙᴇ 🎧", url=f"{url}")],
                [InlineKeyboardButton(text="❌ Close", callback_data="cls")],
            ]
        )
        requested_by = message.from_user.first_name
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="🎧 **Pʟᴀyɪɴɢ** Hᴇʀᴇ Nᴏᴡ - Sᴏɴɢ Rᴇqᴜᴇꜱᴛᴇᴅ By {} Vɪᴀ Sᴀᴍᴀɴᴛʜᴀ Mᴜꜱɪᴄꜱ 🎧".format(
